...
# this solution is not from me, it is from mebeim on github. Check first cell in ipynb file for timestamps of progress.
...
fin = open("day_four/day_four_data.txt",'r')
